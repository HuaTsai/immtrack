...
TEST_CASE("Update with predicted measurement leaves state approximately "
          "unchanged and shrinks cov", "[update]") {
    Filter ukf;
    Filter::StateVec x0;
...
TEST_CASE("Update converges to ground truth under repeated measurements",
          "[update]") {
